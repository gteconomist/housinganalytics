...
export const METRICS = [
  ...
  { field: 'homeowner_vacancy_rate',     label: 'Homeowner vacancy rate',                  group: 'Stock',   format: 'pct',   source: 'ACS 2024, B25004 + DP04 (derived per Census)' },
  { field: 'rental_vacancy_rate',        label: 'Rental vacancy rate',                     group: 'Stock',   format: 'pct',   source: 'ACS 2024, B25004 + DP04 (derived per Census)' },

  // ─── Vacancy composition (B25004) ─────────────────────────────────
  // The 7 disjoint vacancy categories + their shares + the structural /
  // frictional split + seasonal & distress shares of total stock.
  { field: 'vacant_total',               label: 'Vacant — total units',                    group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_for_rent',            label: 'Vacant — for rent',                       group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_rented_not_occ',      label: 'Vacant — rented, not yet occupied',       group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_for_sale',            label: 'Vacant — for sale only',                  group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_sold_not_occ',        label: 'Vacant — sold, not yet occupied',         group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_seasonal',            label: 'Vacant — seasonal / recreational',        group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_migrant',             label: 'Vacant — for migrant workers',            group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_other',               label: 'Vacant — other (structural distress)',    group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004' },
  { field: 'vacant_for_rent_share',      label: 'Vacant for rent — share of vacancy',      group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_rented_not_occ_share',label: 'Rented not occupied — share of vacancy',  group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_for_sale_share',      label: 'Vacant for sale — share of vacancy',      group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_sold_not_occ_share',  label: 'Sold not occupied — share of vacancy',    group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_seasonal_share',      label: 'Seasonal — share of vacancy',             group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_migrant_share',       label: 'Migrant — share of vacancy',              group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_other_share',         label: 'Other vacant — share of vacancy',         group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_frictional',          label: 'Frictional vacant (count)',               group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004 (derived)' },
  { field: 'vacant_structural',          label: 'Structural vacant (count)',               group: 'Vacancy', format: 'count', source: 'ACS 2024, B25004 (derived)' },
  { field: 'frictional_share',           label: 'Frictional share of total vacancy',       group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'structural_share',           label: 'Structural share of total vacancy',       group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'seasonal_stock_share',       label: 'Seasonal share of all housing stock',     group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
  { field: 'distress_stock_share',       label: 'Other-vacant share of all housing stock', group: 'Vacancy', format: 'pct',   source: 'ACS 2024, B25004 (derived)' },
